...
namespace Ramos.CatalogSystem.Api.Controllers
{
    ...
    public class ApplicationController : ControllerBase
    {
        ...
        public ApplicationController(IMediator mediator, IHttpContextAccessor httpContextAccessor)
        {
            _mediator = mediator;
        ...
        {
            var response = await _mediator.Send(new GetAllApplicationsQuery());
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(string id, [FromBody] UpdateApplicationCommand command)
        {
            var response = await _mediator.Send(new UpdateApplicationRequest(id, command));
            return CreateResponse(response);
        }
        ...
        {
            var response = await _mediator.Send(new DeleteApplicationCommand(id));
            return CreateResponse(response);
        }
    }
}